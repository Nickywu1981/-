...
.auth-page {
  ...
  background: var(--bg-secondary, #f9fafb), #f9fafb); padding: 24px;
}
.auth-card {
  width: 100%; max-width: 420px;
  background: var(--bg-card, #ffffff), #fff);
  border-radius: var(--radius-lg, 12px), 16px);
...
.agreement { font-size: var(--text-xs, 0.75rem)); color: var(--text-muted, #9ca3af)); text-align: center; margin-bottom: 16px; }
