      ...
      <div class="ws-section">
        ...
        <div v-else-if="task.status.value === 2" class="result-compare">
          <div class="result-compare__item">
            ...
            <img loading="lazy" v-if="uploadedUrl" :src="uploadedUrl" class="result-compare__img" />
          ...
          <div class="result-compare__item">
            ...
            <img loading="lazy" v-if="task.result.value" :src="task.result.value" class="result-compare__img" />
            <div v-else class="result-compare__img placeholder" />
          </div>
        </div>
