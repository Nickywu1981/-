      ...
      <div class="ws-section">
        ...
        <div v-else-if="task.status.value === 2" class="result-compare">
          ...
          <div class="result-compare__item">
            ...
            <img loading="lazy" v-if="task.result.value" :src="task.result.value" class="result-compare__img" @error="(e) => { (e.target as HTMLImageElement).src = '/images/placeholder.png' }" />
            <div v-else class="result-compare__img placeholder" />
          </div>
        </div>
