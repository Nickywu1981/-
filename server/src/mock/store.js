...
const MOCK_STORE = {
  // ---- 用户（5人） ----
  user: [
    { id: 1, username: 'demo', password: '$2b$10$mQkpJgbwoxCNkEGfKhMcyOzesmhU69.VqRn2xuScfKggXQusgcyKG', nickname: '电商达人小王', role: 'admin', phone: '13812345678', email: 'demo@example.com', avatar: '', status: 1, plan_type: 2, credit_balance: 485, last_login_time: t(-0.1), create_time: '2025-01-15 10:30:00', update_time: now, is_deleted: 0 },
    { id: 6, username: 'admin', password: '$2b$10$UIFu1RJlhpvgw4Ka0KTC0u4j3QM8O8TYqajTfBJg3Tt0vpxr.wQzG', nickname: '超级管理员', role: 'admin', phone: '13800000001', email: 'admin@example.com', avatar: '', status: 1, plan_type: 3, credit_balance: 9999, last_login_time: t(-0.1), create_time: '2025-01-01 00:00:00', update_time: now, is_deleted: 0 },
    ...
    { id: 3, username: 'studio_zhang', password: '$2b$10$xxx', nickname: '美工张', phone: '13611112222', email: 'zhang@example.com', avatar: '', status: 1, plan_type: 3, credit_balance: 1975, last_login_time: t(-0.2), create_time: '2025-04-01 09:15:00', update_time: now, is_deleted: 0 },
    { id: 4, username: 'xiaomei_shop', password: '$2b$10$xxx', nickname: '小美服饰旗舰店', phone: '13733445566', email: 'xiaomei@example.com', avatar: '', status: 1, plan_type: 1, credit_balance: 85, last_login_time: t(-1), create_time: '2025-04-10 16:20:00', update_time: now, is_deleted: 0 },
