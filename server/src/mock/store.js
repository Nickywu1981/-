...
const MOCK_STORE = {
  // ---- 用户（5人） ----
  user: [
    { id: 1, username: 'demo', password: '$2b$10$aSjvQ0ZetmHFuQRZTTXgTOYpt3XnCtxre5PCsL8M3CYCdOvz.9Ege', nickname: '电商达人小王', role: 'admin', phone: '13812345678', email: 'demo@example.com', avatar: '', status: 1, plan_type: 2, credit_balance: 485, last_login_time: t(-0.1), create_time: '2025-01-15 10:30:00', update_time: now, is_deleted: 0 },
