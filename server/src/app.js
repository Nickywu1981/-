...
import { getSpec as getSwaggerSpec } from './config/swagger.js';
...
import { publicRouter as i18nPublicRoutes, adminRouter as i18nAdminRoutes } from './route/i18n.routes.js';
...
import adminRoutes from './route/adminRoutes.js';           // 管理后台统一路由 (仪表板/用户/任务/套餐/风控/通知)
...
import skuBatchRoutes from './route/skuBatchRoutes.js';                // Phase 3: 多SKU批量生成
...
// 全链路追踪 — 注入 TraceID (必须在 requestLogger 之前)
...
app.use('/api/sku-batch', authMiddleware, heavyLimiter, skuBatchRoutes); // Phase 3: 多SKU批量生成
