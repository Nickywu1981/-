...
router.post('/generate', authMiddleware, heavyLimiter, validate(generateSchema), async (req, res, next) => {
  try {
...
router.post('/clone', authMiddleware, heavyLimiter, validate(cloneSchema), async (req, res, next) => {
  try {
