-- Migration: site_config 表 + 默认工作台配置
-- 管理后台 DIY 编辑用户端工作台页面和模块
...
-- 默认工作台配置：五大导航 + 创作类模块卡片
INSERT INTO site_config (config_key, config_value, description) VALUES ('workspace_nav', '[
...
INSERT INTO site_config (config_key, config_value, description) VALUES ('workspace_cards', '[
...
INSERT INTO site_config (config_key, config_value, description) VALUES ('workspace_assistant', '[
...
INSERT INTO site_config (config_key, config_value, description) VALUES ('workspace_workflow', '[
